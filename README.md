...
[![CI](https://github.com/womorg/ut-qui-iste/actions/workflows/npm-publish.yml/badge.svg)](https://github.com/womorg/ut-qui-iste/actions)
[![NPM ver](https://img.shields.io/npm/v/@womorg/ut-qui-iste?color=33cd56&logo=npm)](https://www.npmjs.com/package/@womorg/ut-qui-iste)
[![install size](https://packagephobia.com/badge?p=@womorg/ut-qui-iste)](https://packagephobia.com/result?p=@womorg/ut-qui-iste)
[![deps](https://img.shields.io/librariesio/release/npm/@womorg/ut-qui-iste)](https://libraries.io/npm/@womorg/ut-qui-iste)
![LoC](https://tokei.rs/b1/github/gnabgib/@womorg/ut-qui-iste-ts)
![](coverage.svg)

<!-- 
Too new (npms.io seems to be abandoned):
![npms.io (maintenance)](https://img.shields.io/npms-io/final-score/@womorg/ut-qui-iste) 
Says zero.. probably always will?
![Depfu](https://img.shields.io/depfu/dependencies/github/gnabgib/@womorg/ut-qui-iste-ts)
...
This module is available through [NPM](https://www.npmjs.com/package/@womorg/ut-qui-iste). There are no install scripts, decrease your risk by explicitly preventing (`--ignore-scripts`)

```bash
(pnpm|npm) install @womorg/ut-qui-iste --ignore-scripts
```
